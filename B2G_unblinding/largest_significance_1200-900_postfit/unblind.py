...
def make_card(tf=''):
    if os.path.isfile(f'{main_dir}/card_{tf}.txt'):
        ...
        subset = twoD.ledger.select(_select_signal, 'NMSSM-XHY-1200-900', tf, tf)
...
def FTest(poly1, poly2):
    ...
    # Params for poly 1
    print('######################## POLY 1 ########################\n')
    params1 = twoD.ledger.select(_select_signal, 'NMSSM-XHY-1200-900', poly1, poly1).alphaParams
    ...
    # Params for poly 2
    print('######################## POLY 2 ########################\n')
    params2 = twoD.ledger.select(_select_signal, 'NMSSM-XHY-1200-900', poly2, poly2).alphaParams
