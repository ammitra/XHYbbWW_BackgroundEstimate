#!/bin/bash
####################################################################################################
# Script for fits. This is meant to work on condor nodes where the input ROOT files are in the 
# same directory as the script is being run. 
#
...
####################################################################################################
dataset=data_obs
cards_dir="./" # cards are in same directory as script on condor
